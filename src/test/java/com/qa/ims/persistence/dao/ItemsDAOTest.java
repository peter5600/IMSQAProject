...
public class ItemsDAOTest {
	...
	public void create() {//This test has be written for usage later it can't be used yet because 
		...
		assertEquals(TestItem.getName(), ExpectedItem.getName());//will return null because read latest hasn't been implemnted
	...
	public void ReadAllTest() {
		...
		//assertEquals(TestValues, Expected);//compareing like this leads to the exact same values but not being the same
	...
	public void ReadLatestTest() {
		...
		//i think because of float i can't just compare them i have to specify a delate so do them all individualy
	}
